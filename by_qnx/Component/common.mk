...
EXTRA_SRCVPATH+=$(PROJECT_ROOT_Cmn)

#===== EXTRA_INCVPATH - a space-separated list of directories to search for include files.
EXTRA_INCVPATH+=D:/Tcmsx/Inform  \
...
EXTRA_LIBVPATH+=$(PROJECT_ROOT_PseudoMfb)/$(CPU)/$(patsubst o%,a%,$(notdir $(CURDIR)))  \
	D:/Tcmsx/Mfb/20101130/library
...
EXTRA_OBJS+=C:/QNX641/target/qnx6/z17/ppcbe/usr/lib/mdis/libmdis_api.so  \
