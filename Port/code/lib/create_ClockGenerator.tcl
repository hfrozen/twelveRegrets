...
set result [ run_cg_create "xilinx.com:ip:dcmcs:13.1" "ClockGenerator" "Clock Switching with Two DCMs" "Clock Switching with Two DCMs (xilinx.com:ip:dcmcs:13.1) generated by Project Navigator" xc3s400-5pq208 VHDL ]
